	...
	<!--FUNCION PARA LA NOTIFICACION DE MODIFICADO Y ELIMINADO-->
		<script type="text/javascript">
			function JSalertRegistro(){
				swal("Exito!", " El usuario fue registrado!", "success");
			}

			function JSalertCambiar(){
				swal("Exito!", " Se cambio su pregunta de seguridad!", "success");
			}

			function JSalertContra(){
				swal("Exito!", " Se cambio su contraseña!", "success");
			}

			function JSalertEliminado(){
				swal("Exito!", " Se elimino al usuario!", "success");
			}
		</script>
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<!--Fila para la carta de registrar usuario-->
			<div class="row " style="margin-left: 20px;">
			<!--Carta registrar usuario-->
			<div class="col-md-6" >
				<div class="card">
					<div class="prueba card card-inverse">
								<div class="card-block text-center">
								<h3 class="card-title">Registrar<br> Usuario</h3>
								<a href="registrar_usuario.php" class="pruebaBoton btn btn-block btn-lg"><i class="icon-eye"></i></a>
								</div>

						</div>
				</div>
			</div><!--Fin carta registrar usuario-->
			<!--Carta eliminar usuario-->
			<div class="col-md-6">
				<div class="card">
					<div class="prueba card card-inverse">
								<div class="card-block text-center">
								<h3 class="card-title">Eliminar<br> Usuario</h3>
								<a href="eliminar_usuario.php" class="pruebaBoton btn btn-block btn-lg"><i class="icon-cancel"></i></a>
								</div>

						</div>
				</div>
			</div><!--Fin carta eliminar usuario-->
		</div><!--Fin fila para la carta de registrar usuario-->

			<!--Fila para las cartas de cambiar pass y pregunta de seguridad-->
			...
			<div class="col-md-6">
				<div class="card">
					<div class="prueba card card-inverse">
								<div class="card-block text-center">
								<h3 class="card-title">Cambiar <br> Contraseña</h3>
								<a href="formulario_contrasena.php" class="pruebaBoton btn btn-block btn-lg"><i class="icon-menu"></i></a>
								</div>

						</div>
				</div>
			</div><!--Fin carta cambiar pass-->

			<!--Carta cambiar pregunta-->
			<div class="col-md-6">
				<div class="card">
					<div class="prueba card card-inverse">
								<div class="card-block text-center">
								<h3 class="card-title">Cambiar Pregunta<br> Seguridad</h3>
								<a href="cambiar_pregunta.php" class="pruebaBoton btn btn-block btn-lg"><i class="icon-eye"></i></a>
								</div>

						</div>
				</div>
			</div><!--Fin carta cambiar pregunta-->
		</div><!--Fin fila para las cartas de cambiar pregunta y pass-->
