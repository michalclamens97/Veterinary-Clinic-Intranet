...
<head>
	...
	<!--FUNCION PARA LA NOTIFICACION DE MODIFICADO Y ELIMINADO-->
		<script type="text/javascript">
			function JSalert(){
				swal("Exito!", "El producto fue insertado!", "success");
			}
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="card">
					<div class="prueba card card-inverse">
								...
								<h3 class="card-title">Insertar <br> Producto</h3>
								<a href="insertar_productos.php" class="pruebaBoton btn btn-block btn-lg"><i class="icon-menu"></i></a>
								</div>
			...
			<div class="col-md-6">
				<div class="card">
					<div class="prueba card card-inverse">
								<div class="card-block text-center">
								<h3 class="card-title">Ver <br> Productos</h3>
								<a href="mostrar_productos_dataTable.php" class="pruebaBoton btn btn-block btn-lg"><i class="icon-eye"></i></a>
								</div>
...
<!--REVISO SI TENGO EN LA URL LA VARIABLE FINALIZADO, SI ES ASI ENTONCES LLAMO A LA FUNCION DE JS PARA MOSTRAR NOTIFICACION DE EXITO-->
	<?php
