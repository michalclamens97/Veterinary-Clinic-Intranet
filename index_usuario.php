...
//Para que el admin no pueda entrar al index de los usuarios, esta es la unica pagina a la que el admin no puede entrar.
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<?php require'views/HeadTipo2.php';?>
			...
			<!--Carta insertar cliente-->
			<div class="col-md-4">
				<div class="card">
					<div class="prueba card card-inverse">
								<div class="card-block text-center">
								<h3 class="card-title">Insertar <br> Cliente</h3>
								<a href="formulario_insertar_cliente.php" class="pruebaBoton btn btn-block btn-lg"><i class="icon-user-add"></i></a>
								</div>
			...
			<!--Carta mostrar consultas-->
			<div class="col-md-4">
				<div class="card">
					<div class="prueba card card-inverse">
								<div class="card-block text-center">
								<h3 class="card-title"> Mostrar <br> Consultas</h3>
								<a href="mostrar_consultas_dataTable.php" class="pruebaBoton btn btn-block btn-lg"><i class="icon-th-thumb"></i></a>
								</div>
			...
			<div class="col-md-4">
				<div class="card">
					<div class="prueba card card-inverse">
								<div class="card-block text-center">
								<h3 class="card-title">Panel <br> General</h3>
								<a href="index_panel_general.php" class="pruebaBoton btn btn-block btn-lg"><i class="icon-clipboard"></i></a>
								</div>
