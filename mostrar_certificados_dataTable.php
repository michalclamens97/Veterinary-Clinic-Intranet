<?php session_start();
	...
	$statement = $conexion->prepare("SELECT * FROM vacunacion");
	$statement->execute();
					...
					<tbody>
						...
						<?php foreach ($resultado as $row): ?>
							...
							<tr>
								...
								<td><?php echo $row['FECHA_PROXIMA']; ?></td>
								<td><?php echo $row['ITEM']; ?></td>
								<td><?php echo $row['CANTIDAD']; ?></td>
								<td><a class="icon-file-pdf" href="generar_certificado_vacunacion.php?id_mascota=<?php echo $row['ID_MASCOTA'].'&fecha_a='.$row['FECHA_APLICACION'].'&fecha_p='.$row['FECHA_PROXIMA'].'&item='.$row['ITEM'].'&cantidad='.$row['CANTIDAD']; ?> " target="_blank"></a></td>
