...
<html lang="es">
	<head>
		...
		<script type="text/javascript">
			function JSalertMascota(){
				swal("Exito!", "Mascota agregada!", "success");
			}
					...
					<tbody>
						...
						<?php foreach ($resultado as $row): ?>
							...
							<tr>
								...
								<td><a class="icon-stethoscope" href="formulario_consulta.php?cedula=<?php echo $row['CEDULA']; ?> " ></a></td>
