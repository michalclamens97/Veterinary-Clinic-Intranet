<?php session_start();
	...
	$statement = $conexion->prepare("SELECT * FROM cliente ORDER BY CEDULA");
	$statement->execute();
...
<html lang="es">
	<head>
		...
		<script type="text/javascript">
			function JSalertClienteModificado(){
				swal("Exito!", "Los datos del cliente fueron modificados!", "success");
			}

			function JSalertClienteModificadoUsuario(){
				swal("Exito!", "Los datos del cliente fueron modificados!", "success");
			}

			function JSalertClienteError(){
				swal("Error!", "Ya existe un cliente con esa cedula!", "warning");
			}
					...
					<tbody>
						...
						<?php foreach ($resultado as $row): ?>
							...
							<tr>
								...
								<td><a class="icon-pencil" href="editar_cliente.php?ci=<?php echo $row['CEDULA']; ?> " ></a></td>
...
<script type="text/javascript" src="js/main.js"></script>
	...
	<?php
		...
		if (isset($_GET['clienteModificado'])) {

			echo"
				<script>

				JSalertClienteModificado();

				</script>
			";
		}

		if (isset($_GET['clienteModificadoUsuario'])) {

			echo"
				<script>

				JSalertClienteModificadoUsuario();

				</script>
			";
		}

		if (isset($_GET['clienteError'])) {
