<?php session_start();
	...
	$statement = $conexion->prepare("SELECT * FROM medicamentos");
	$statement->execute();
	...
	<meta charset="UTF-8">
		...
		<script type="text/javascript">
			function JSalertModificado(){
				swal("Exito!", "El medicamento fue modificado!", "success");
			}

			function JSalertEliminado(){
				swal("Exito!", "El medicamento fue eliminado!", "success");
			}
		</script>
					...
					<tbody>
						...
						<?php foreach ($resultado as $row): ?>
							...
							<tr>
								...
								<td><a class="icon-pencil" href="editar_medicamento.php?medicamento=<?php echo $row['NOMBRE']; ?> " ></a></td>
								
								<td><a href="#" class="icon-trash" data-href="eliminar_medicamento.php?medicamento=<?php echo $row['NOMBRE']; ?>" data-toggle="modal" data-target="#confirm-delete"></a></td>
							</tr>
						<?php endforeach ?>
