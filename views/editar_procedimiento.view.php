				...
				<div id="ui">
					...
					<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" id="form_registro" class="form-group text-center">
						...
						<div class="row">
							...
							<input type="text" name="procedimiento" id="procedimiento" class="form-control"  value="<?php echo $fila['PROCEDIMIENTO']; ?>" hidden>
							<div class="col-md-6">
							<!--Input solo para mostrar el producto en pantalla, como tal no lo uso para mas nada-->
								<label for="producto">Procedimiento:</label>
								<input type="text" name="product" id="product" class="form-control"  value="<?php echo $fila['PROCEDIMIENTO']; ?>" disabled>
							</div>
						...
						</div><!--Fin fila el procedimiento y precio-->
