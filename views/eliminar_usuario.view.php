...
<body>
	<div class="container-fluid">
		<div class="row">
			...
			<div class="row mt-3 justify-content-center" style="margin-left: 20px;">
			...
			<div class="col-md-6">
					...
					<div class="prueba card card-inverse">
								...
								<h3 class="card-title">Eliminar<br>Usuario</h3>
									<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" id="form_registro" method="POST">
											<label>Seleccione el usuario a eliminar:</label><br>
											<select  name="usuario" id="usuario" class="required form-control"  title="Seleccione un usuario" >
												<option value="usuarios" selected disabled>Usuario...</option>
												<?php foreach ($resultado as $dato): ?>
												<option value="<?php echo $dato['USUARIO']; ?>"><?php echo ucwords($dato['USUARIO']); ?></option>
												<?php endforeach ?>
											</select>
											<br>
											<button type="submit" class="pruebaBoton btn btn-block btn-lg mb-1">Eliminar Usuario</button>
										</form>
								</div>
				...
				<div id="secundario" class="row" style="margin-left: 20px;">
				...
				<br>
				<p style="text-align:center; margin-left: 30px;"><b>Clínica Veterinaria La Mascota, Dr. Alfredo Puchi V-05886848-1 / (0295) 262.56.55 <br> Derechos Reservados Universidad de Margarita &reg; 2019</b></p>
